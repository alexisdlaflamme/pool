...
reqStatsJoueursNHL<-function(){
  ...
  statsJoueursNHL<- paste(getwd(), "/Data/NHL/BataBaseStatsJoueur.xlsx", sep = "")
  ...
  statsJoueurs <- read_excel(statsJoueursNHL, sheet = "Stats Joueurs", col_types = ColTypesJoueurs, col_names = ColNamesJoueurs, skip = 1)
...
reqStatsGardienNHL<-function(){
  ...
  statsGardiens <- read_excel(statsJoueursNHL, sheet = "Stats Gardiens", col_types = ColTypesGardiens, col_names = ColNamesGardiens, skip = 1)
