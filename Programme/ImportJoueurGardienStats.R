setwd("C:\\Users\\Alexis\\Dropbox\\Pool 2017-2018\\Pool 2018-2019\\Data\\NHL")
...
reqStatsJoueursNHL<-function(){
  ...
  statsJoueurs <- read_excel("BataBaseStatsJoueur.xlsx", sheet = "Stats Joueurs", col_types = ColTypesJoueurs, col_names = ColNamesJoueurs, skip = 1)
...
reqStatsGardienNHL<-function(){
  ...
  statsGardiens <- read_excel("BataBaseStatsJoueur.xlsx", sheet = "Stats Gardiens", col_types = ColTypesGardiens, col_names = ColNamesGardiens, skip = 1)
